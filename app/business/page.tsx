...
function getAnalytics(orders: KitchenOrder[], currentMenu: MenuLookupItem[]) {
  ...
  const dailyProductSales = buildProductSales(orders.filter((order) => isSameLocalDay(order, today)), currentMenu);
    ...
    <main className="min-h-screen bg-[#eef1f3] px-4 py-5 text-slate-900 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-6xl">
        <header className="rounded-[2rem] bg-[#111827] p-5 text-white shadow-xl shadow-slate-900/10 sm:p-7">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm font-semibold leading-6 text-white/70">Track live orders, sales, menu performance and item availability for this café only.</p>
            </div>
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <section className="rounded-[2rem] bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-orange-600">Order split</p><h2 className="mt-1 text-xl font-black">Categories</h2>
